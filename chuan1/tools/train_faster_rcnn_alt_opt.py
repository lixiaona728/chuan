...
def parse_args():
    ...
    parser.add_argument('--weights', dest='pretrained_model',
                        help='initialize with pretrained model weights',
                        default='E:/code/py-faster-rcnn-master/py-faster-rcnn-master/data/imagenet_models/ZF.v2.caffemodel',
                        type=str)
    ...
    parser.add_argument('--cfg', dest='cfg_file',
                        help='optional config file',
                        default='E:/code/py-faster-rcnn-master/py-faster-rcnn-master/experiments/cfgs/faster_rcnn_alt_opt.yml',
                        type=str)
